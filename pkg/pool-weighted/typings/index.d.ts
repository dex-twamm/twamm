declare module 'bignumber.js' {
  ...
  export default class BigNumber {
    ...
    static config(settings?: ISettings): ISettings;
    ...
    dividedToIntegerBy(n: number, base?: number): BigNumber;
    dividedToIntegerBy(n: string, base?: number): BigNumber;
    dividedToIntegerBy(n: BigNumber, base?: number): BigNumber;

    divToInt(n: number, base?: number): BigNumber;
    divToInt(n: string, base?: number): BigNumber;
    divToInt(n: BigNumber, base?: number): BigNumber;
